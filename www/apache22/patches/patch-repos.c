...
--- modules/dav/fs/repos.c.orig	2011-09-08 15:59:38.011010048 +0000
+++ modules/dav/fs/repos.c
@@ -191,6 +191,7 @@ struct dav_stream {
     apr_pool_t *p;
     apr_file_t *f;
...
@@ -841,6 +842,14 @@ static int dav_fs_is_parent_resource(
             && ctx2->pathname[len1] == '/');
 }
...
+
 static dav_error * dav_fs_open_stream(const dav_resource *resource,
                                       ...
                                       dav_stream **stream)
@@ -849,6 +858,7 @@ static dav_error * dav_fs_open_stream(co
...
+    char* fpath;
     ...
     switch (mode) {
     default:
@@ -865,7 +875,18 @@ static dav_error * dav_fs_open_stream(co
...
@@ -879,16 +900,32 @@ static dav_error * dav_fs_open_stream(co
