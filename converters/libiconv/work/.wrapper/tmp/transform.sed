...
s|^-L/boot/common/pkg/packages/[^/ 	`"':;,]*\(/[^ 	`"':;,]*\)$|-L/boot/common/pkg\1|g
s|^/boot/common/pkg\(/[^ 	`"':;,]*\.la[ 	`"':;,]\)|_bUiLdLiNk__boot_develop_hpkgsrc_converters_libiconv_work_.buildlink#\1|g
s|^/boot/common/pkg\(/[^ 	`"':;,]*\.la\)$|_bUiLdLiNk__boot_develop_hpkgsrc_converters_libiconv_work_.buildlink#\1|g
s|^-I/boot/common/pkg\([ 	`"':;,]\)|-I_bUiLdLiNk__boot_develop_hpkgsrc_converters_libiconv_work_.buildlink#\1|g
s|^-I/boot/common/pkg$|-I_bUiLdLiNk__boot_develop_hpkgsrc_converters_libiconv_work_.buildlink#|g
s|^-I/boot/common/pkg\(/[^ 	`"':;,]*\)\([ 	`"':;,]\)|-I_bUiLdLiNk__boot_develop_hpkgsrc_converters_libiconv_work_.buildlink#\1|g
s|^-I/boot/common/pkg\(/[^ 	`"':;,]*\)$|-I_bUiLdLiNk__boot_develop_hpkgsrc_converters_libiconv_work_.buildlink#\1|g
s|^-L/boot/common/pkg\([ 	`"':;,]\)|-L_bUiLdLiNk__boot_develop_hpkgsrc_converters_libiconv_work_.buildlink#\1|g
s|^-L/boot/common/pkg$|-L_bUiLdLiNk__boot_develop_hpkgsrc_converters_libiconv_work_.buildlink#|g
s|^-L/boot/common/pkg\(/[^ 	`"':;,]*\)\([ 	`"':;,]\)|-L_bUiLdLiNk__boot_develop_hpkgsrc_converters_libiconv_work_.buildlink#\1|g
s|^-L/boot/common/pkg\(/[^ 	`"':;,]*\)$|-L_bUiLdLiNk__boot_develop_hpkgsrc_converters_libiconv_work_.buildlink#\1|g
s|^-I/[^ 	`"':;,]*\([ 	`"':;,]\)|\1|g
s|^-I/[^ 	`"':;,]*$||g
