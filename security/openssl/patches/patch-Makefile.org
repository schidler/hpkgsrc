...
--- Makefile.org.orig	2012-04-19 06:40:47.040632320 +0000
+++ Makefile.org
@@ -28,6 +28,7 @@ INSTALLTOP=/usr/local/ssl
 
 # Do not edit this manually. Use Configure --openssldir=DIR do change this!
 OPENSSLDIR=/usr/local/ssl
+EXAMPLEDIR=$(INSTALLTOP)/documentation/examples/openssl
 
 # NO_IDEA - Define to build without the IDEA algorithm
 # NO_RC4  - Define to build without the RC4 algorithm
@@ -131,7 +132,7 @@ TESTS = alltests
...
+MANDIR=$(INSTALLTOP)/$(PKGMANDIR)
 ...
 MAN3=3
 MANSUFFIX=
@@ -148,6 +149,7 @@ SHARED_CRYPTO=libcrypto$(SHLIB_EXT)
