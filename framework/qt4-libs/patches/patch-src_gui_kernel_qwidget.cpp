...
--- src/gui/kernel/qwidget.cpp.orig	2011-12-08 05:06:02.011796480 +0000
+++ src/gui/kernel/qwidget.cpp
@@ -1508,6 +1508,20 @@ void QWidget::create(WId window, bool in
...
@@ -12716,6 +12730,53 @@ void QWidgetPrivate::syncUnifiedMode() {
